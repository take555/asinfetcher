...
/**
 * This is the model class for table "mercury_attribute".
 *
 * @property integer $id
...
class Attribute extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Card::className(), ['attribute_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Logaction::className(), ['attribute_id' => 'id']);
    }
}
